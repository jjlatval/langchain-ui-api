...
default_template = """Assistant is a large language model trained by OpenAI.
...
discussions on a wide range of topics. As a language model, 
...
allowing it to engage in discussions and provide 
...
help with a specific question or just want to have a conversation 
...
default_prompt = PromptTemplate(
    input_variables=["history", "human_input"], template=default_template
)
